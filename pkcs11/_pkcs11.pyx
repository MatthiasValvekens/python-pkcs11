...
cdef class Session(HasFuncList, types.Session):
    ...
    def generate_key(self, key_type, key_length=None,
        ...
        template_ = self.attribute_mapper.default_secret_key_template(
    ...
    def _generate_keypair(self, key_type, key_length=None,
        ...
        public_template_ = self.attribute_mapper.default_public_key_template(
        ...
        private_template_ = self.attribute_mapper.default_private_key_template(
            id=id, label=label, store=store, capabilities=capabilities,
        )
...
class GenerateWithParametersMixin(types.DomainParameters):
    def generate_keypair(self,
        ...
        # Build attributes
        public_template_ = session.attribute_mapper.default_public_key_template(
            id=id, label=label, store=store, capabilities=capabilities,
        )
        ...
        private_template_ = session.attribute_mapper.default_private_key_template(
            id=id, label=label, store=store, capabilities=capabilities,
        )
